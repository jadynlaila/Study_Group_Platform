...
**Automated Tests Location**: [Message Controller Tests](https://github.com/jadynlaila/Study_Group_Platform/blob/dev/backend/controllers/messageController.test.js)

**Test Case Example**: ![Example](res/jadyn_d4/rudra_example.png)
